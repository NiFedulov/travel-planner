    ...
    <div className="min-h-screen bg-gradient-to-br from-teal-50 via-white to-sky-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-500 mt-1">Sign in to continue planning your trips</p>
        </div>

        {error && (
          <div className="mb-4 p-3 rounded-xl bg-red-50 border border-red-200 text-sm text-red-700 text-center">
            {error === 'google_cancelled' ? 'Google sign-in was cancelled' : 'Google sign-in failed. Try again.'}
          </div>
        )}
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button type="submit" disabled={loading} className="w-full bg-teal-600 hover:bg-teal-700 py-5 font-semibold">
          ...
          <p className="text-center text-sm text-gray-500">
            ...
            <Link href="/auth/signup" className="text-teal-600 hover:text-teal-700 font-medium">Create one</Link>
          </p>
        </div>
      </div>
    </div>
